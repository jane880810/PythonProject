...
class AnimationController:
    def __init__(self):
        ...
        self.joint5_pos = None  # 新增：記錄J5標記位置
...
class RobotControlGUI:
    ...
    def __init__(self, root, controller):
        ...
        self.root.geometry("850x750+0+50")  # 視窗位置在左上角
    ...
    def update_display(self):
        ...
        try:
            ...
            self.root.after(1000, self.update_display)  # 改為1000ms (1秒更新一次)
        except:
            pass
...
def main_loop():
    ...
    try:
        while not exit_flag:
            now = time.time()
            # 控制迴圈 100 Hz，animate() 裡再用 trajectory_delay 控制軌跡點間隔
            if now - last > 1 / 100:
                ctrl.animate()
                last = now
