...
20250916
繁體中文
HP60C 深度相機顯示 - PyCharm相容版本 + YOLOv8人物辨識 + 深度測距
解決cv_bridge庫載入問題，加入YOLOv8人物檢測功能和深度測距
    ...
    def draw_detections(self, cv_image, detections):
        ...
        for detection in detections:
            ...
            if distance is not None and distance <= 120:
                warning_text = "The distance is too close!"
...
def main():
    """主程式進入點"""
    try:
        print("啟動PyCharm HP60C相機人物檢測+深度測距程式...")
        ...
        print("程式執行中，等待圖像資料...")
        print("在PyCharm中成功執行HP60C相機人物檢測+深度測距!")
